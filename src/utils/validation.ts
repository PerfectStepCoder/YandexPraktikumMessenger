...
export const validationRules: ValidationRules = {
  ...
  login: {
    ...
    errorMessage:
      "Логин должен быть от 3 до 20 символов, без пробелов, может содержать цифры, дефис или нижнее подчёркивание.",
  },
  name: {
    regex: /^(?!^\d+$)[a-zA-Z0-9_-]{3,20}$/,
    errorMessage:
  ...
  phone: {
    regex: /^\+?\d{10,15}$/,
    errorMessage:
      "Телефон должен содержать от 10 до 15 цифр, может начинаться с плюса.",
  },
  message: {
    regex: /.+/,
